            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                ...
                <li :class="{ active: isTwo }">
                  <a >价格<span v-show="isTwo" class="iconfont" :class="{icon-jiantou_xiangshang:searchParams.order.indexOf('asc') != -1}"></span></a>
                </li>
...
<script>
  ...
  export default {
    ...
    computed:{
        ...
        isDesc(){
            return this.searchParams.order.indexOf('de') != -1;
        }
    },
    methods:{
